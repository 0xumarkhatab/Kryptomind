...
function ProductInformation({ product }) {
  return (
    <div id={"p" + product.id} className="product__information">
      <h1>{product.name}</h1>
      <br />
      <p>{product.description}</p>
      <div id={product} className="product__specifications">
        <p className="product__specifications__heading">Technology</p>
        <p className="product__specifications__heading">Product Platform</p>
        <p className="product__specifications__heading">Product Category</p>
